...
$(document).ready(function(){
	$('#btn_iniciar_jogo').click(function() {
		...
		//exibir os apelidos 
		$('#nome_jogador_1').css("color","red");
		$('#nome_jogador_1').html($('#entrada_apelido_jogador_1').val());
		$('#nome_jogador_2').css("color","LightSkyBlue");
		...
		function jogada(identidade){
			...
			$('#' +identidade).css('background-image',icone); 

			var linha_coluna = identidade.split('-');
